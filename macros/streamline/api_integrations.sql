{% macro create_aws_bitcoin_api() %}
    {% if target.name == "prod" %}
        {% set sql %}
        CREATE api integration IF NOT EXISTS aws_bitcoin_api api_provider = aws_api_gateway api_aws_role_arn = 'arn:aws:iam::924682671219:role/bitcoin-api-prod-rolesnowflakeudfsAF733095-D1PYK9UQXd8m' api_allowed_prefixes = (
